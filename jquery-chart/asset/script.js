function GetStock() {
    ...
    if (form.valid()) {
        ...
        /* URL for AJAX Call */
        var myURL1 = "https://api.polygon.io/v2/aggs/ticker/AAPL/range/1/day/2020-06-01/2020-06-17?apiKey=*" + StockSymbol + "/company?apiKey=" + apiKey;
        ...
        /* URL for AJAX Call */
        var myURL2 = "https://api.polygon.io/v2/aggs/ticker/AAPL/range/1/day/2020-06-01/2020-06-17?apiKey=*" + StockSymbol + "/range/1/day/" + FromDate + "/" + ToDate + "?unadjusted=false&sort=asc&limit=32&apiKey=" + apiKey;
        ...
        $(document).ready(function() { 
            ...
            $.ajax({
              method: myMethod2,
              url:"https://api.polygon.io/v2/reference/markets?&apiKey=*"
            })
